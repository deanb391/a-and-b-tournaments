...
export default function CreateSponsorPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await apiClient.sponsors.create(formData);
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-black uppercase text-navy">Add Sponsor</h1>
          <p className="text-navy/60 font-bold">Create a new tournament sponsor.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white border-4 border-navy shadow-[8px_8px_0px_#0A192F] p-8 space-y-6">
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="Briefly describe the sponsor..."
          />
        </div>
        ...
        >
          {isSubmitting ? "Creating..." : <><Save size={20} /> Create Sponsor</>}
        </button>
      </form>
    </div>
  );
